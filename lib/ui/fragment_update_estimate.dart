...
class _UpdateEstimateFragmentState extends State<UpdateEstimateFragment>
  ...
  void initState() {
    ...
    _CameraImage = SignaturePlaceholder();
    nextDate =
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Text(
                      offline
                          ? "Offline"
                          : widget.customer.EstimateId.isEmpty
                              ? "Loading"
...
/*------------------Agreement DRAWING------------------*/
  ...
  getEstimateData() async {
    try {
      ...
      var result =
          await http.get(BASE_URL + API_GET_ESTIMATE, headers: headers);
      setState(() {
        offline = false;
      });
      if (result.statusCode == 200) {
